...
\begin{enumerate}
\item Búsqueda de material bibliográfico. (55 hs)
	\begin{enumerate}
	...
	\item Estudiar cómo funciona cada uno de los componentes. (20 hs)
	\end{enumerate}
\item Adquisición de componentes. (16 hs)
	\begin{enumerate}
	...
	\item Realizar un informe de costos de los componentes adquiridos (4 hs)
	\end{enumerate}
\item Diseño y configuración de Red Local. (16 hs)
	\begin{enumerate}
	\item Instalación del Modem/router en el lugar mas adecuado. (2 hs)
	\item Instalación del Access Point en el lugar mas adecuado. (3 hs)
	...
	\item Realizar un informe de la configuración de red local instalada. (2 hs)
	\end{enumerate}
\item Desarrollo del Modulo Principal
	\begin{enumerate}
	\item Instalación del sistema operativo en la Raspberry Pi (1 hs)
	\item Instalación y configuración del servidor web (3 hs)
	\item Instalación y configuración de Python 3 (2 hs)
	\item Instalación y configuración del Broker Local (4 hs)
	...
	\item Creación y configuración del script lanzador que iniciará automáticamente los programas al encender el modulo. (3 hs)
	\item Testeo del funcionamiento y conexión a la red inicial del modulo. (5 hs)
	...
	\item Integración de las funcionalidades backend con el fronted de la aplicación web (30 hs)
	\item Testeo de funcionamiento de la aplicación web.  (5 hs)
	...
	\item Tarea 5 (tantas hs)
	\end{enumerate}
\item Desarrollo del Modulo Replica
	\begin{enumerate}
	...
	\item Tarea 5 (tantas hs)
	\end{enumerate}
\item Desarrollo del Modulo de Consumo
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
	...
	\item Tarea 5 (tantas hs)
	\end{enumerate}
\item Desarrollo del Modulo Temperatura
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
	...
	\item Tarea 5 (tantas hs)
	\end{enumerate}
\item Desarrollo del Modulo Actuador
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
	...
	\item Tarea 5 (tantas hs)
	\end{enumerate}
\item Verificación y testeo del sistema
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
